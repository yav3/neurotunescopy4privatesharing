...
export function LoginForm({ onToggleMode }: LoginFormProps) {
  ...
  return (
    <div className="w-full max-w-md space-y-6">
      ...
      {error && (
        <div className="bg-red-500/20 border border-red-500/40 rounded-lg p-4 backdrop-blur-sm">
      ...
      <div className="text-center space-y-3">
        <button
          ...
          className="text-white/80 hover:text-white text-sm font-medium block w-full transition-colors"
        >
