...
export function LandingPage({ onLogin, onSignup }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-blue-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-blue-600/30 via-blue-800/20 to-transparent" />
      ...
      {/* Floating Art Elements - Nature and Wavelength themed */}
      <div className="absolute top-20 left-10 w-32 h-32 opacity-10 animate-pulse">
        <img src="/lovable-uploads/acoustic-sunset-field.png" alt="" className="w-full h-full object-cover rounded-full blur-sm" />
      </div>
      <div className="absolute top-40 right-20 w-24 h-24 opacity-15 animate-pulse delay-1000">
        <img src="/lovable-uploads/beta-waterfall.png" alt="" className="w-full h-full object-cover rounded-lg blur-sm" />
      </div>
      <div className="absolute bottom-40 left-20 w-28 h-28 opacity-10 animate-pulse delay-2000">
        <img src="/lovable-uploads/alpha-mountain-lake.png" alt="" className="w-full h-full object-cover rounded-full blur-sm" />
      </div>
      <div className="absolute bottom-20 right-16 w-36 h-36 opacity-10 animate-pulse delay-500">
        <img src="/lovable-uploads/gamma-sunbeam-forest.png" alt="" className="w-full h-full object-cover rounded-lg blur-sm" />
      </div>
      
      {/* Wavelength SVG Elements */}
      <div className="absolute top-1/3 left-1/3 w-40 h-8 opacity-5 animate-pulse delay-1500">
        <svg viewBox="0 0 200 40" className="w-full h-full">
          <path d="M0,20 Q25,5 50,20 T100,20 T150,20 T200,20" stroke="currentColor" strokeWidth="2" fill="none" className="text-blue-300"/>
        </svg>
      </div>
      <div className="absolute bottom-1/3 right-1/3 w-32 h-6 opacity-5 animate-pulse delay-2500">
        <svg viewBox="0 0 160 30" className="w-full h-full">
          <path d="M0,15 Q20,5 40,15 T80,15 T120,15 T160,15" stroke="currentColor" strokeWidth="2" fill="none" className="text-cyan-300"/>
        </svg>
      </div>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-3/4 right-1/3 w-1 h-1 rounded-full bg-blue-400/30 animate-pulse delay-1000"></div>
        <div className="absolute top-1/2 left-1/6 w-3 h-3 rounded-full bg-blue-400/15 animate-ping delay-2000"></div>
      ...
      <nav className="relative z-50 flex justify-between items-center p-6 bg-black/20 backdrop-blur-2xl border-b border-white/10 shadow-2xl shadow-black/20">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
          ...
          <Button 
            ...
            className="w-full sm:w-auto bg-gradient-to-r from-blue-500 via-blue-500 to-blue-600 hover:from-blue-600 hover:via-blue-600 hover:to-blue-700 text-white border-0 shadow-xl shadow-blue-500/30 backdrop-blur-sm"
          >
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-3xl p-8 md:p-12 shadow-2xl shadow-black/30 mb-8">
            <div className="flex justify-center mb-6">
              <div className="w-20 h-20 rounded-full bg-gradient-to-r from-blue-500 via-blue-500 to-blue-600 flex items-center justify-center shadow-2xl shadow-blue-500/30 animate-pulse relative overflow-hidden">
                <svg viewBox="0 0 60 60" className="w-12 h-12 text-white">
                  <path d="M10,30 Q20,15 30,30 T50,30" stroke="currentColor" strokeWidth="3" fill="none"/>
                  <path d="M5,30 Q15,20 25,30 T45,30 T55,30" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.6"/>
                </svg>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg" 
                onClick={handleSignup} 
                className="w-full sm:w-auto px-8 py-4 text-lg bg-gradient-to-r from-blue-500 via-blue-500 to-blue-600 hover:from-blue-600 hover:via-blue-600 hover:to-blue-700 text-white border-0 shadow-2xl shadow-blue-500/40 backdrop-blur-sm transform hover:scale-105 transition-all duration-300"
              >
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-8">
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-4 py-2 text-sm text-white/90 shadow-lg shadow-black/10">
              <svg className="w-4 h-4 inline mr-2" viewBox="0 0 16 16" fill="currentColor">
                <circle cx="8" cy="8" r="1" fill="currentColor"/>
                <circle cx="8" cy="8" r="3" fill="none" stroke="currentColor" strokeWidth="1" opacity="0.6"/>
              </svg>
              Evidence-Based
            </div>
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-4 py-2 text-sm text-white/90 shadow-lg shadow-black/10">
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-full px-4 py-2 text-sm text-white/90 shadow-lg shadow-black/10">
              <svg className="w-4 h-4 inline mr-2" viewBox="0 0 16 16" fill="currentColor">
                <path d="M3,8 L5,5 L7,11 L9,3 L11,9 L13,6" stroke="currentColor" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
              </svg>
              Therapeutic
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="group text-center bg-white/5 backdrop-blur-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-blue-500/20 transform hover:-translate-y-2">
            <CardContent className="pt-8 pb-6 relative">
              ...
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
          ...
          <Card className="group text-center bg-white/5 backdrop-blur-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-blue-500/20 transform hover:-translate-y-2">
            <CardContent className="pt-8 pb-6 relative">
              ...
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-blue-500 to-blue-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
                <svg viewBox="0 0 32 32" className="w-8 h-8 text-white">
                  <path d="M4,16 Q8,8 12,16 T20,16 T28,16" stroke="currentColor" strokeWidth="2" fill="none"/>
                  <path d="M2,16 Q6,12 10,16 T18,16 T26,16 T30,16" stroke="currentColor" strokeWidth="1.5" fill="none" opacity="0.7"/>
                </svg>
              </div>
          ...
          <Card className="group text-center bg-white/5 backdrop-blur-2xl border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-500 shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-blue-500/20 transform hover:-translate-y-2">
            <CardContent className="pt-8 pb-6 relative">
              ...
              <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-r from-blue-500 to-cyan-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
                <svg viewBox="0 0 32 32" className="w-8 h-8 text-white">
      ...
      <section className="relative z-20 bg-gradient-to-r from-blue-950/40 via-blue-950/30 to-slate-900/40 backdrop-blur-2xl border-y border-white/10 shadow-inner shadow-black/20">
        <div className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-2xl p-8 shadow-2xl shadow-black/30">
              <div className="flex justify-center mb-6">
                <div className="w-16 h-16 rounded-full bg-gradient-to-r from-cyan-500 to-blue-600 flex items-center justify-center shadow-xl shadow-cyan-500/30 relative overflow-hidden">
                  <svg viewBox="0 0 40 40" className="w-8 h-8 text-white">
                    <circle cx="20" cy="20" r="3" fill="currentColor"/>
                    <path d="M8,20 Q14,10 20,20 T32,20" stroke="currentColor" strokeWidth="2" fill="none" opacity="0.8"/>
                    <path d="M6,20 Q12,12 18,20 T30,20 T36,20" stroke="currentColor" strokeWidth="1" fill="none" opacity="0.5"/>
                  </svg>
                </div>
              </div>
              ...
              <div className="flex justify-center gap-8 mt-8 opacity-60">
                <div className="w-8 h-8 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 animate-pulse"></div>
                <div className="w-6 h-6 rounded-full bg-gradient-to-r from-blue-400 to-blue-500 animate-pulse delay-500"></div>
                <div className="w-10 h-10 rounded-full bg-gradient-to-r from-blue-400 to-cyan-500 animate-pulse delay-1000"></div>
              </div>
            </div>
          </div>
        </div>
