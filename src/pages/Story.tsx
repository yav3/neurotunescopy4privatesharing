      ...
      <main className="pt-32 pb-28">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="space-y-20" style={{ color: 'rgba(228, 228, 228, 0.65)' }}>
            ...
            {/* Environmental Music */}
            <section>
              <h2 className="text-3xl font-light mb-8" style={{ color: '#e4e4e4' }}>Environmental Music for Senior Living</h2>
              ...
              <div className="p-6 rounded-2xl mb-8" style={{ background: 'rgba(228, 228, 228, 0.03)', border: '1px solid rgba(228, 228, 228, 0.08)' }}>
                ...
                <p className="leading-relaxed" style={{ color: 'rgba(228, 228, 228, 0.65)' }}>
                  Each room an administrative user controls is designed to enhance the experience of those in the space. Continuous play 
                  with advanced schedule programming enables the delivery of music sessions that meet the specific needs of spaces, taking 
                  environmental factors, staff and faculty needs, community health, and visitor comfort into consideration.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <div className="p-6 rounded-2xl" style={{ background: 'rgba(228, 228, 228, 0.03)', border: '1px solid rgba(228, 228, 228, 0.08)' }}>
                  ...
                  <p className="leading-relaxed text-sm" style={{ color: 'rgba(228, 228, 228, 0.65)' }}>
                    ...
                    community needs. Administrative users can add notes and teach the playlists to improve through favoriting and 
              ...
              <div className="p-6 rounded-2xl" style={{ background: 'rgba(6, 182, 212, 0.05)', border: '1px solid rgba(6, 182, 212, 0.15)' }}>
                ...
                <ul className="space-y-3 text-sm" style={{ color: 'rgba(228, 228, 228, 0.65)' }}>
                  ...
                  <li className="flex items-start gap-3">
                    <span style={{ color: 'rgba(6, 182, 212, 0.8)' }}>•</span>
                    <span>Delivers benefits for members, visitors, patients, staff, faculty, and employees—reduced anxiety and improved focus</span>
                  </li>
                </ul>
              </div>
            </section>
