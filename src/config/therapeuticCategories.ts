...
export const THERAPEUTIC_CATEGORIES: TherapeuticCategory[] = [
  ...
  },
  {
    ...
    buckets: ['audio', 'neuralpositivemusic', 'pop', 'moodboostremixesworlddance', 'countryandamericana', 'ENERGYBOOST', 'NewAgeandWorldFocus'],
    image: moodBoostCard
  },
  {
    id: 'pain-support',
    name: 'Pain Distraction',
    description: 'Gentle music for pain distraction and comfort',
