...
export const THERAPEUTIC_GOALS: TherapeuticGoal[] = [
  ...
  },
  {
    ...
    musicBuckets: ['newageworldstressanxietyreduction', 'sonatasforstress', 'Chopin', 'samba', 'verified_music_collection', 'neuralpositivemusic', 'painreducingworld'],
  ...
  },
  {
    ...
    musicBuckets: ['neuralpositivemusic/House', 'pop', 'moodboostremixesworlddance', 'neuralpositivemusic/EDM', 'HIIT'],
