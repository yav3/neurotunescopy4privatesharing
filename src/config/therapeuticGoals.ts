...
export const THERAPEUTIC_GOALS: TherapeuticGoal[] = [
  {
    ...
    icon: Brain,
    artwork: '/src/assets/focus-artwork.jpg',
    color: 'blue',
  ...
  },
  {
    ...
    icon: Sparkles,
    artwork: '/src/assets/stress-anxiety-artwork.jpg',
    color: 'green',
  ...
  },
  {
    ...
    icon: Waves,
    artwork: '/public/lovable-uploads/acoustic-sunset-field.png',
    color: 'indigo',
  ...
  },
  {
    ...
    icon: Zap,
    artwork: '/src/assets/mood-boost-artwork.jpg',
    color: 'cyan',
  ...
  },
  {
    ...
    icon: Shield,
    artwork: '/src/assets/energy-boost-artwork.jpg',
    color: 'teal',
  ...
  },
  {
    ...
    icon: Flower,
    artwork: '/src/assets/pain-support-artwork.jpg',
    color: 'gray',
