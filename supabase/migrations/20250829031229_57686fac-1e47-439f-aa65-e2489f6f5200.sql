-- Add storage reference columns to music_tracks table
ALTER TABLE music_tracks 
ADD COLUMN file_path TEXT,
ADD COLUMN bucket_name TEXT DEFAULT 'neuralpositivemusic',
ADD COLUMN file_size BIGINT,
ADD COLUMN file_type TEXT,
ADD COLUMN upload_status TEXT DEFAULT 'completed';

-- Add therapeutic applications table for frequency band analysis
...
-- This creates a mapping from track titles to audio files
